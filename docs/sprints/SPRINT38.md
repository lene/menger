# Sprint 38: Advanced Geometry

**Sprint:** 38 - Advanced Geometry
**Status:** Not Started
**Estimate:** ~27 hours
**Branch:** `feature/sprint-38`
**Dependencies:** None
...
### Task 38.1: Sponge Cutaways via Clipping Planes
...
### Task 38.2: Schläfli Polytope Generator
...
### Task 38.3: Fractal Subdivision on Polychora
...
|------|-------------|----------|
| 38.1 | Sponge cutaways via clipping planes | 6h |
| 38.2 | Schläfli polytope generator | 10h |
| 38.3 | Fractal subdivision on polychora | 8h |
| 38.4 | Tests + documentation | 3h |
| **Total** | | **~27h** |

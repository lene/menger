...
### Changed
- Sprint 26 planning now tracks repository split work and requires every open
  High/Medium/Low Priority CODE_IMPROVEMENTS issue to be resolved before closure.
- Local agent artifacts are ignored via `.gitignore`.

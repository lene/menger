...
### Added
- **Caustics Rendering** - Progressive Photon Mapping for realistic light focusing through glass
  - Enable with `--caustics`, configure with `--caustics-photons` and `--caustics-iterations`

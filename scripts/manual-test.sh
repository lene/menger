...
run_test "Blue+Red spheres side by side (separate tinted shadows)" "-o --objects type=sphere:pos=-1.2,0,0:color=#0000FF80:ior=1.5 --objects type=sphere:pos=1.2,0,0:color=#FF000080:ior=1.5 --shadows --transparent-shadows --plane y:-2 -s $OUTPUT_DIR/115-colored-shadow-side-by-side.png"
run_test "Blue+Red spheres overlapping (combined magenta tint)" "-o --objects type=sphere:pos=0,0,-0.5:color=#0000FF80:ior=1.5:size=0.6 --objects type=sphere:pos=0,0,0.5:color=#FF000080:ior=1.5:size=0.6 --shadows --transparent-shadows --plane y:-2 -s $OUTPUT_DIR/116-colored-shadow-combined.png"
run_test "Transparent blue + opaque behind (opaque wins)" "-o --objects type=sphere:pos=-0.6,0,0:color=#0000FF80:ior=1.5 --objects type=sphere:pos=0.6,0,0:color=#888888FF:ior=1.0 --shadows --transparent-shadows --plane y:-2 -s $OUTPUT_DIR/117-colored-shadow-transparent-opaque.png"
run_test "Three stacked transparent (RGB triple accumulation)" "-o --objects type=sphere:pos=-2,0,0:color=#FF000080:ior=1.5 --objects type=sphere:pos=0,0,0:color=#00FF0080:ior=1.5 --objects type=sphere:pos=2,0,0:color=#0000FF80:ior=1.5 --shadows --transparent-shadows --plane y:-2 -s $OUTPUT_DIR/118-colored-shadow-triple.png"
...
interactive_tests=(
    ...
    "Red sphere colored shadow (Phase 1):-o --objects type=sphere:color=#FF000080:ior=1.5 --shadows --transparent-shadows --plane y:-2"
    "Green sphere colored shadow (Phase 1):-o --objects type=sphere:color=#00FF0080:ior=1.5 --shadows --transparent-shadows --plane y:-2"
    "Blue sphere colored shadow (Phase 1):-o --objects type=sphere:color=#0000FF80:ior=1.5 --shadows --transparent-shadows --plane y:-2"
    "RGB spheres colored shadows (Phase 1):-o --objects type=sphere:pos=-2,0,0:color=#FF000080:ior=1.5 --objects type=sphere:pos=0,0,0:color=#00FF0080:ior=1.5 --objects type=sphere:pos=2,0,0:color=#0000FF80:ior=1.5 --shadows --transparent-shadows --plane y:-2"
    "Glass sphere colored shadow (Phase 1):-o --objects type=sphere:material=glass --shadows --transparent-shadows --plane y:-2"
    "Blue+Red side-by-side shadows (Phase 2):-o --objects type=sphere:pos=-1.2,0,0:color=#0000FF80:ior=1.5 --objects type=sphere:pos=1.2,0,0:color=#FF000080:ior=1.5 --shadows --transparent-shadows --plane y:-2"
    "Blue+Red overlapping combined tint (Phase 2):-o --objects type=sphere:pos=0,0,-0.5:color=#0000FF80:ior=1.5:size=0.6 --objects type=sphere:pos=0,0,0.5:color=#FF000080:ior=1.5:size=0.6 --shadows --transparent-shadows --plane y:-2"

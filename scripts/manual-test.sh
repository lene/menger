...
run_test "DSL: PrismDispersion" "-o --scene examples.dsl.PrismDispersion --width 320 --height 240 --allow-uniform-render -s $OUTPUT_DIR/155-prism-dispersion.png"
run_test "DSL: DiamondFire" "-o --scene examples.dsl.DiamondFire --width 320 --height 240 --allow-uniform-render -s $OUTPUT_DIR/156-diamond-fire.png"
...
interactive_tests=(
    "Basic sphere:-o --objects type=sphere --plane y:-2"
    "Glass refraction:-o --objects type=sphere:material=glass --plane y:-2"
    "Water:-o --objects type=sphere:material=water --plane y:-2"
    "Diamond:-o --objects type=sphere:material=diamond --plane y:-2"
    "Glass dispersive:-o --objects type=sphere:pos=0,0.5,0:size=0.3:material=glass-dispersive:ior=1.5 --plane y:-2 --accumulation-frames 16"
    "Diamond dispersive:-o --objects type=sphere:pos=0,0.5,0:size=0.3:material=diamond-dispersive:ior=2.42 --plane y:-2 --accumulation-frames 16"
    "Chrome (metallic):-o --objects type=sphere:material=chrome --plane y:-2"
    "Gold (metallic):-o --objects type=sphere:material=gold --plane y:-2"
    "Copper (metallic):-o --objects type=sphere:material=copper --plane y:-2"
    "Film (translucent):-o --objects type=sphere:material=film --plane y:-2"
    ...
    "Glass dispersive (prism effect):-o --objects type=sphere:pos=0,0.5,0:size=0.3:material=glass-dispersive:ior=1.5 --plane y:-2 --accumulation-frames 16"
    "Diamond dispersive (fire):-o --objects type=sphere:pos=0,0.5,0:size=0.3:material=diamond-dispersive:ior=2.42 --plane y:-2 --accumulation-frames 16"
    "Parchment (semi-translucent):-o --objects type=cube:material=parchment --plane y:-2"
    "Metal (blue):-o --objects type=sphere:material=metal:color=#4488ff --plane y:-2"
    "Plastic (red):-o --objects type=sphere:material=plastic:color=#ff4444 --plane y:-2"
    "Matte (green):-o --objects type=sphere:material=matte:color=#44ff44 --plane y:-2"
    "Emissive sphere:-o --objects type=sphere:material=film:emission=5.0:color=#ff8800 --plane y:-2"
    "Textured cube:-o --texture-dir scripts/test-assets --objects type=cube:texture=test_checker.png --plane y:-2"
    "Textured cube + glass:-o --texture-dir scripts/test-assets --objects type=cube:texture=test_checker.png:material=glass --plane y:-2"
    "Two spheres + shadows:-o --objects type=sphere:pos=-0.8,0,0:material=glass --objects type=sphere:pos=0.8,0,0 --shadows --plane y:-2"
    "Sponge surface L1:-o --objects type=sponge-surface:level=1 --plane y:-2"
    "Cube Sponge L1:-o --objects type=cube-sponge:level=1:color=#00ffff --max-instances 64 --plane y:-2"
    "Tesseract (4D hypercube):-o --objects type=tesseract --plane y:-2"
    "Tesseract (4D rotated):-o --objects type=tesseract:rot-xw=45:rot-yw=30:rot-zw=15 --plane y:-2"
    "Tesseract (glass):-o --objects type=tesseract:material=glass --plane y:-2"
    "Tesseract (chrome):-o --objects type=tesseract:material=chrome --plane y:-2"
    "Tesseract with chrome edges:-o --objects type=tesseract:edge-material=chrome:edge-radius=0.02 --plane y:-2"
    "Tesseract with cyan glow edges:-o --objects type=tesseract:edge-color=#00ffff:edge-emission=5.0:edge-radius=0.03 --plane y:-2"
    "Tesseract glass + gold edges:-o --objects type=tesseract:material=glass:edge-material=gold:edge-radius=0.025 --plane y:-2"
    "Tesseract film + magenta glow:-o --objects type=tesseract:material=film:edge-color=#ff00ff:edge-emission=5.0:edge-radius=0.03 --plane y:-2"
    "Tesseract rotated with edges:-o --objects type=tesseract:rot-xw=45:rot-yw=30:edge-material=chrome:edge-radius=0.02 --plane y:-2"
    "TesseractSponge L1 (4D Menger):-o --objects type=tesseract-sponge:level=1 --plane y:-2"
    "TesseractSponge L1 rotated:-o --objects type=tesseract-sponge:level=1:rot-xw=45:rot-yw=30 --plane y:-2"
    "TesseractSponge L1 glass:-o --objects type=tesseract-sponge:level=1:material=glass --plane y:-2"
    "TesseractSponge2 L1 (surface 4D):-o --objects type=tesseract-sponge-2:level=1 --plane y:-2"
    "TesseractSponge2 L2:-o --objects type=tesseract-sponge-2:level=2 --plane y:-2"
    "TesseractSponge2 L1 chrome:-o --objects type=tesseract-sponge-2:level=1:material=chrome --plane y:-2"
    "TesseractSponge L1 + chrome edges:-o --objects type=tesseract-sponge:level=1:edge-material=chrome:edge-radius=0.015 --plane y:-2"
    "TesseractSponge2 glass + gold edges:-o --objects type=tesseract-sponge-2:level=1:material=glass:edge-material=gold:edge-radius=0.02 --plane y:-2"
    "Mixed 4D sponges (red+green):-o --objects type=tesseract-sponge:level=1:pos=-0.8,0,0:color=#ff4444 --objects type=tesseract-sponge-2:level=1:pos=0.8,0,0:color=#44ff44 --plane y:-2"
    "4D sponge + 3D sphere:-o --objects type=tesseract-sponge-2:level=1:pos=-0.8,0,0:material=glass --objects type=sphere:pos=0.8,0,0:material=chrome --plane y:-2"
    "TesseractSponge L0.5 (fractional):-o --objects type=tesseract-sponge:level=0.5 --plane y:-2"
    "TesseractSponge L1.5 (fractional):-o --objects type=tesseract-sponge:level=1.5 --plane y:-2"
    "TesseractSponge2 L1.3 (fractional):-o --objects type=tesseract-sponge-2:level=1.3 --plane y:-2"
    "Fractional L1.5 glass:-o --objects type=tesseract-sponge:level=1.5:material=glass --plane y:-2"
    "Fractional L1.4 rotated:-o --objects type=tesseract-sponge-2:level=1.4:rot-xw=30:rot-yw=20 --plane y:-2"
    "Mixed fractional + integer:-o --objects type=tesseract-sponge:level=1.5:pos=-0.8,0,0 --objects type=tesseract-sponge:level=1:pos=0.8,0,0 --plane y:-2"
    "SpongeByVolume L0.5 (3D fractional):-o --objects type=sponge-volume:level=0.5 --plane y:-2"
    "SpongeByVolume L1.5 (3D fractional):-o --objects type=sponge-volume:level=1.5 --plane y:-2"
    "SpongeBySurface L1.25 (3D fractional):-o --objects type=sponge-surface:level=1.25 --plane y:-2"
    "SpongeBySurface L1.75 (3D fractional):-o --objects type=sponge-surface:level=1.75 --plane y:-2"
    "3D Fractional glass:-o --objects type=sponge-volume:level=1.5:material=glass"
    "3D Fractional chrome:-o --objects type=sponge-surface:level=1.3:material=chrome --plane y:-2"
    "3D Mixed frac levels:-o --objects type=sponge-volume:level=1.5:pos=-0.8,0,0:color=#FF8844 --objects type=sponge-volume:level=1:pos=0.8,0,0:color=#4488FF --plane y:-2"
    "3D Volume vs Surface frac:-o --objects type=sponge-volume:level=1.5:pos=-0.8,0,0 --objects type=sponge-surface:level=1.5:pos=0.8,0,0 --plane y:-2"
    ...
    "Colored lights:-o --objects type=sphere --light point:-3,3,2:1.0:ff0000 --light point:3,3,2:1.0:0000ff --plane y:-2"
    ...
    "DSL CausticsReferenceDefault (primitive sphere, high-quality caustics — compare to ParametricSphereCaustics):-o --scene examples.dsl.CausticsReferenceDefault"
    ...
    "Icosahedron caustics (faceted glass mesh, PPM caustics on floor):-o --objects type=icosahedron:size=0.8:material=glass --camera-pos 0,1.5,6 --camera-lookat 0,0,0 --light point:0,10,0:500 --plane y:-2 --plane-color cccccc --caustics --caustics-photons 500000 --caustics-iterations 20"
    "Recursive IAS Sponge L2:-o --objects type=sponge-recursive-ias:level=2 --plane y:-2"
    "Recursive IAS Sponge L4 (deep):-o --objects type=sponge-recursive-ias:level=4 --plane y:-2"
    "Recursive IAS Sponge L6 + glass:-o --objects type=sponge-recursive-ias:level=6:material=glass --plane y:-2"
    ...
    "Pentachoron (5-cell):-o --objects type=pentachoron:size=2:material=film --cross --cross-thickness 0.01 --plane y:-2"
    "16-cell:-o --objects type=16-cell:size=2:material=film --cross --cross-thickness 0.01 --plane y:-2"
    "24-cell:-o --objects type=24-cell:size=2:material=film --cross --cross-thickness 0.01 --plane y:-2"
    "Pentachoron gold edges:-o --objects type=pentachoron:size=0.8:material=film:edge-material=gold:edge-radius=0.02 --plane y:-2"
    "16-cell chrome edges:-o --objects type=16-cell:size=0.8:material=film:edge-material=chrome:edge-radius=0.02 --plane y:-2"
    "24-cell gold edges:-o --objects type=24-cell:size=2:material=film:edge-material=gold:edge-radius=0.005 --plane y:-2"
    "600-cell:-o --objects type=600-cell:size=1.2:material=film --cross --cross-thickness 0.01 --plane y:-2"
    "120-cell:-o --objects type=120-cell:size=1.2:material=film --cross --cross-thickness 0.01 --plane y:-2"
    "600-cell gold edges:-o --objects type=600-cell:size=0.8:material=film:edge-material=gold:edge-radius=0.01"
    "120-cell chrome edges:-o --objects type=120-cell:size=0.8:material=film:edge-material=chrome:edge-radius=0.05 --plane y:-2"
    "Menger4D L1 glass:-o --objects type=menger4d:level=1:material=glass --plane y:-2"
    "Menger4D L3 chrome:-o --objects type=menger4d:level=3:material=chrome --plane y:-2"
    "Menger4D L4 matte:-o --objects type=menger4d:level=4:material=matte --plane y:-2"
    "Menger4D two objects (L2+L3):-o --objects type=menger4d:level=2:pos=-0.8,0,0 --objects type=menger4d:level=3:pos=0.8,0,0 --plane y:-2"
    "Menger4D fractional L2.5:-o --objects type=menger4d:level=2.5 --plane y:-2"
    "Sierpinski4D L1 matte:-o --objects type=sierpinski4d:level=1 --plane y:-2"
    "Sierpinski4D L3 chrome:-o --objects type=sierpinski4d:level=3:material=chrome --plane y:-2"
    "Sierpinski4D L2 rotated (rot-xw=45):-o --objects type=sierpinski4d:level=2:rot-xw=45 --plane y:-2"
    ...
    "Hexadecachoron4D L1 matte:-o --objects type=hexadecachoron4d:level=1 --plane y:-2"
    "Hexadecachoron4D L3 chrome:-o --objects type=hexadecachoron4d:level=3:material=chrome --plane y:-2"
    "Hexadecachoron4D L2 rotated (rot-xw=45):-o --objects type=hexadecachoron4d:level=2:rot-xw=45 --plane y:-2"
    "Sierpinski4D fractional L2.5:-o --objects type=sierpinski4d:level=2.5 --plane y:-2"
    "Hexadecachoron4D fractional L2.5:-o --objects type=hexadecachoron4d:level=2.5 --plane y:-2"
    "Sponge-recursive-ias fractional L2.5:-o --objects type=sponge-recursive-ias:level=2.5 --plane y:-2"
